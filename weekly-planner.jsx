...
const INITIAL_TASKS = [
  { id: 1, task: "Przygotować się do spotkania spółkowego", project: "Ovoc Malinovi", priority: "A", subPriority: 1, wig: "wig1", deadline: "2026-03-03", status: "todo", person: "" },
  { id: 2, task: "Ustalić cele (WIG/lead/lag) dla Kacpra", project: "Ovoc Malinovi", priority: "A", subPriority: 2, wig: "wig1", deadline: "2026-03-05", status: "todo", person: "Kacper" },
  { id: 3, task: "Rozliczyć Szczepana", project: "Ovoc Malinovi", priority: "A", subPriority: 3, wig: "", deadline: "", status: "todo", person: "Szczepan" },
  { id: 4, task: "Rozliczenie pracowników — pilne", project: "Plantacja", priority: "A", subPriority: 4, wig: "", deadline: "", status: "todo", person: "" },
  { id: 5, task: "Znaleźć doradcę — wnioski o dofinansowanie obszarowe", project: "Plantacja", priority: "A", subPriority: 5, wig: "", deadline: "", status: "todo", person: "" },
  { id: 6, task: "Spotkanie z Panią Marleną — platforma godzin pracy", project: "Plantacja", priority: "B", subPriority: 1, wig: "", deadline: "", status: "todo", person: "Marlena" },
  { id: 7, task: "Pogadać z Olgierdem — współpraca projekty", project: "Plantacja", priority: "B", subPriority: 2, wig: "", deadline: "", status: "todo", person: "Olgierd" },
  { id: 8, task: "Wysłać dokumenty do kredytu", project: "Plantacja", priority: "B", subPriority: 3, wig: "", deadline: "", status: "todo", person: "" },
  { id: 9, task: "Rozliczyć Kuligów", project: "Plantacja", priority: "B", subPriority: 4, wig: "", deadline: "", status: "todo", person: "Kulig" },
  { id: 10, task: "Koncept dashboard/portal dla Plantacji", project: "Plantacja", priority: "C", subPriority: 1, wig: "", deadline: "", status: "todo", person: "Olgierd" },
  { id: 11, task: "Zapłacić za doradztwo", project: "Inne", priority: "C", subPriority: 2, wig: "", deadline: "", status: "todo", person: "" },
];
...
export default function WeeklyPlanner() {
  ...
  const addTask = () => {
    ...
    setTasks((prev) => [...prev, { ...newTask, id: maxId + 1, subPriority: sameP.length + 1, status: "todo" }]);
    ...
    <div style={{ minHeight: "100vh", background: "#FAFAF9", color: "#1A1A1A", fontFamily: "'DM Sans', 'Helvetica Neue', sans-serif" }}>
      ...
      <div style={{ padding: "0 36px 16px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          {!isCurrentWeek() && (
            <button onClick={() => setCurrentDate(new Date(2026, 2, 1))} style={{ ...navBtnStyle, padding: "6px 14px", width: "auto", fontSize: 11, fontFamily: "'Space Mono', monospace", color: "#16A34A", borderColor: "#BBF7D0", background: "#F0FDF4" }}>Dziś</button>
          )}
        </div>
